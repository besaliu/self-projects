...
int main(){
   ...
   cout << endl;
// Added test case FindPrev_value
Z.insertBefore(34);
Z.insertBefore(77);
Z.insertBefore(77);
Z.insertBefore(1);
...
Z.insertBefore(55);
Z.insertBefore(77);
cout << "Z after inserting elements: " << Z << " Cursor position: " << Z.position() << endl;
if (Z.findPrev(99) != -1)
...
Z.moveBack();
Z.cleanup();
cout << "Z after cleanup: " << Z << " Cursor position: " << Z.position() << endl;
if (Z.findPrev(1) != 2)
    cout << "Test case 6 failed" << endl;
if (Z.findPrev(1) != -1)
    cout << "Test case 7 failed" << endl;

cout << "Z at the end: " << Z << " Cursor position: " << Z.position() << endl;

// Added test case Assign_equals
X.insertAfter(2);
X.insertAfter(1);
Y = X;
cout << "X = " << X << " Cursor position: " << X.position() << endl;
cout << "Y = " << Y << " Cursor position: " << Y.position() << endl;
if (!X.equals(Y))
    cout << "Test case 1 failed" << endl;

cout << "X at the end: " << X << " Cursor position: " << X.position() << endl;
cout << "Y at the end: " << Y << " Cursor position: " << Y.position() << endl;
return 0;
